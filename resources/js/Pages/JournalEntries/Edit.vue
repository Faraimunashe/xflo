<template>
    ...
    <SectionHeader title="Edit Journal Entry" />
          ...
          <form @submit.prevent="submit">
            ...
            <div class="mt-6 sticky bottom-0 bg-white border-t border-gray-200 p-4 -mx-6 -mb-6">
              ...
              <div class="flex justify-end space-x-3">
                <SecondaryButton type="button" @click="$inertia.visit(`/journal-entries/${entry.id}`)">
                  Cancel
                </SecondaryButton>
...
const form = useForm({
  ...
  lines: props.entry.journal_lines?.map(line => ({
...
const submit = () => {
  form.put(`/journal-entries/${props.entry.id}`, {
    preserveScroll: true,
  });
};
</script>
